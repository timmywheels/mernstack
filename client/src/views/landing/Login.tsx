...
const Login = () => {
    ...
    useEffect(() => {
        if (auth.authenticated) history.push('/dashboard');
    }, [auth]);
    ...
    const handleSubmit = async (e: any) => {
        ...
        if (res.ok) {
            ...
            if(!user.ok) {
                emitToastNotification(dispatch, { title: "Incorrect Credentials", message: "The email and password combination you entered is incorrect. Please try again.", type: NotificationType.ERROR}, 7500);
            } else if (user.ok) {
                setLoading(true);
                ...
                emitToastNotification(dispatch, { title: "Login Error", message: "The email and password combination you entered is incorrect. Please try again.", type: NotificationType.ERROR }, 7500);
            }
        }
    };
                            ...
                            <div>
                                <a href={"/auth/google/login"}
                                   className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
                                    ...
                                    <svg className="h-5 w-5" fill="#737373" viewBox="0 0 256 262"
