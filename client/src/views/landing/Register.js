...
const Register = () => {
    ...
    const { dispatch } = react_1.useContext(NotificationContext_1.default);
    ...
    const handleSubmit = async (e) => {
        ...
        notificationUtils_1.emitToastNotification(dispatch, notification);
        if (notification.type === constants_1.NotificationType.SUCCESS) {
            history.push(constants_1.Redirect.CONFIRM_EMAIL);
        }
    };
                    ...
                    <form onSubmit={(e) => handleSubmit(e)}>
                        <div>
                            ...
                            <div className="mt-1 rounded-md shadow-sm">
                                <input id="name" type="name" name={'name'} onChange={(e) => setName(e.target.value)} value={name} required className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5"/>
                            </div>
                        </div>
                        <div className="mt-6">
                        ...
                        <div className="mt-6 flex items-center justify-between">
                            <div className="text-sm leading-5">
                                <react_router_dom_1.Link to={'/login'} className="font-bold text-gray-600 hover:text-gray-500 focus:outline-none focus:underline transition ease-in-out duration-150">
